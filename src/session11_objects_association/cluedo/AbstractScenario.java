...
public abstract class AbstractScenario<I extends Enum<I> & Guessable<I> & Item<I>> implements GameScenario<I>
{
  ...
  public boolean moveToRoom(Scanner scanner)
  {
    ...
    Room chosenRoom = InputUtils.promptForEnum(Room.class, scanner,
  ...
  {
    return InputUtils.promptForEnum(Room.class, scanner, getRoomPromptText(), getRoomListHeader());
  }
  ...
  {
    return InputUtils.promptForEnum(Suspect.class, scanner, getSuspectPromptText(), getSuspectListHeader());
  }
  ...
  public boolean evaluateFinalGuess(Room guessedRoom, Suspect guessedSuspect,
      I guessedItem)
  {
  ...
  @Override public void setWinner(Player winner)
  {
    this.winner = winner;
  }
