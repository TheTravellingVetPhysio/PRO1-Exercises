...
public class CleanupEvaluateStudent
{
  public static void main(String[] args)
  {
    ...
    System.out.println(
        "Test 2 - Expected: Professional driver with good score");
  ...
  static void evaluateStudent(int age, boolean hasLicense, int score,
      String category)
  {
    if (age >= 18 && hasLicense && score >= 80 && category.equals("student"))
    {
      System.out.println("Student driver with good score");
    }
    else if (age >= 18 && hasLicense && score >= 80 && category.equals(
        "professional"))
    {
      System.out.println("Professional driver with good score");
    }
    else if (age >= 18 && hasLicense && score >= 80)
    {
      System.out.println("Driver with good score");
    }
    else if (age >= 18 && hasLicense && score >= 60)
    {
